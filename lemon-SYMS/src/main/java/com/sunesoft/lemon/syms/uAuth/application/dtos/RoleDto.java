...
public class RoleDto {
    ...
    private List<PermissionGroupDto> privilegeGroupList; // 角色下的权限组
    ...
    public List<PermissionGroupDto> getPrivilegeGroupList() {
        return privilegeGroupList;
    }

    public void setPrivilegeGroupList(List<PermissionGroupDto> privilegeGroupList) {
