package com.sunesoft.lemon.fr.ddd.infrastructure.repo.hibernate;
...
public class GenericHibernateRepository<E, K extends Serializable> {
	...
	/**
	 * 初始化 {@link com.sunesoft.lemon.fr.ddd.infrastructure.repo.hibernate.GenericHibernateRepository} 的新实例。
	 */
    ...
    protected String getDialectName(){
        String dialectClassName = ((SessionImpl) this.getSession()).getFactory().getDialect().getClass().getName();
        return (dialectClassName != null && !"".equals(dialectClassName)) ? dialectClassName.substring(dialectClassName.lastIndexOf(".")+1) : "";
	}
}
