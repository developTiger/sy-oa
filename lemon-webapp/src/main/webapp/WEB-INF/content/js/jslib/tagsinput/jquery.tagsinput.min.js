(function (a) {
    ...
    a.fn.removeTag = function (d) {
        ...
        this.each(function () {
            ...
            //var abc1=abc.split(",");
            //var abc3="";
            for(i = 0; i < def1.length; i++){
                var def2=def1[i].split("@");
                //var abc2=abc1[i].split("@");
                ...
                def3=def3.substring(0,def3.length-1)+",";
                //abc3=abc3.substring(0,abc3.length-1)+",";
            }
            def3=def3.substring(0,def3.length-1);
            //abc3=abc3.substring(0,abc3.length-1);
            if(def3.substr(0,1)==","){
                def3=def3.substring(1,def3.length);
            }
            //if(abc3.substr(0,1)==","){
            //    abc3=abc3.substring(1,abc3.length);
            //}
            $('#def').val(def3);
            //$("#abc").val(abc3);
                    ...
                    a(f.fake_input).bind("blur", f, function (b) {
                        ...
                        if (a(b.data.fake_input).val() != "" && a(b.data.fake_input).val() != c) {
                            ...
                            if(!h) {
                                ...
                                //    $('#abc').val("0@" + zhi + sss);
                                //} else {
                                //    $('#abc').val($('#abc').val() + ",0@" + zhi + sss);
                                //}
                                var def=$('#def').val();
                                if (def == "") {
                                    $('#def').val("0@" + zhi + sss);
                                } else {
                                    $('#def').val($('#def').val() + ",0@" + zhi + sss);
                                }
                            }
                        } else {
