...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "ajax_kg01_lotTpl4";
        var tpl = require("text!app/tpl/projectInfo/syy_kg_lc01_lotTpl4.html");
    ...
    //群审批否决上一级
    $("body").delegate("#lotReject4", "click", function () {
        var chk_value = [];
...
//群审批同意
    $("body").delegate("#lotApprove4", "click", function () {
        var chk_value = [];
        $('.checkBtn:checked').each(function () {
            chk_value.push($(this).val());
        });
