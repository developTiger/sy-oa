...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "syy_kg06_plTpl8";
        var tpl = require("text!app/tpl/delivers/syy_kg_lc06_lotTpl8.html");
...
//群审批否决
    ...
    function ajax_lotProjectNO(prono,allContent) {
        var options = {
            url: "syy_kg_lc06_approve7?t=" + new Date().getMilliseconds() + "&ids=" + prono +"&allContent=" +encodeURI(encodeURI(allContent))+"&no=no",
            type: 'get',
