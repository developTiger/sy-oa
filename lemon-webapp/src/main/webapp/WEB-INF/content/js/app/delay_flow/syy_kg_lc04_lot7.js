...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "syy_kg04_plTpl7";
        var tpl  = require("text!app/tpl/delay/syy_kg_lc04_lotTpl7.html");
...
//群审批打回上一级
    ...
    function ajax_lotProjectNO(prono,allContent) {
        var options = {
            url: "syy_kg_lc04_approve_lot7?t=" + new Date().getMilliseconds() + "&ids=" + prono +"&content=" +encodeURI(encodeURI(allContent))+"&appvalue=2",
            type: 'get',
...
//群审批同意
    ...
    function ajax_lotProjectYES(prono,allContent) {
        var options = {
            url: "syy_kg_lc04_approve_lot7?t=" + new Date().getMilliseconds() + "&ids=" + prono +"&content=" +encodeURI(encodeURI(allContent))+"&appvalue=1",
            type: 'get',
            success: function (data) {
                if(data=="success"){
                    alert("签核成功");
