...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "ajax_kg05_lotTpl0";
        var tpl = require("text!app/tpl/projectInfo/syy_kg_lc05_kgTpl0.html");
...
//群审批同意
    ...
    function ajax_lotProjectYES(prono, sid, allContent) {
        var options = {
            url: "ajax_approval_approve?t=" + new Date().getMilliseconds() + "&ids=" + prono + "&empids=" + sid + "&allContent=" + encodeURI(encodeURI(allContent)),
            type: 'get',
            success: function (data) {
                if (data == "success") {
                    alert("签核成功");
