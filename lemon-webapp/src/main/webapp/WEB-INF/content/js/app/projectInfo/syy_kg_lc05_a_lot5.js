...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "ajax_kg05_lotTpl5";
        var tpl = require("text!app/tpl/projectInfo/syy_kg_lc05_kgTpl5.html");
...
//群审批打回上一级
    ...
    function ajax_lotProjectNO(selectids, sid, allContent) {
        var options = {
            url: "ajax_approval_reject?t=" + new Date().getMilliseconds() + "&ids=" + selectids + "&empids=" + sid + "&allContent=" + encodeURI(encodeURI(allContent)),
            type: 'get',
...
//群审批同意
    ...
    function ajax_lotProjectYES(prono, sid, allContent) {
        var options = {
            url: "ajax_approval_approve001?t=" + new Date().getMilliseconds() + "&ids=" + prono + "&empids=" + sid + "&allContent=" + encodeURI(encodeURI(allContent)),
            type: 'get',
            success: function (data) {
                if (data == "success") {
                    alert("签核成功");
