...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "syy_kg06_plTpl1";
        var tpl  = require("text!app/tpl/delivers/syy_kg_lc06_lotTpl1.html");
...
//群审批打回上一级
    ...
    function ajax_lotProjectNO(prono,allContent) {
        var options = {
            url: "syy_kg_lc06_approve1?t=" + new Date().getMilliseconds() + "&ids=" + prono +"&content=" +encodeURI(encodeURI(allContent))+"&back=back",
            type: 'get',
...
//群审批同意
    ...
    function ajax_lotProjectYES(prono,allContent) {
        var options = {
            url: "syy_kg_lc06_approve1?t=" + new Date().getMilliseconds() + "&ids=" + prono +"&content=" +encodeURI(encodeURI(allContent)),
            type: 'get',
            success: function (data) {
                if(data=="success"){
                    alert("签核成功");
