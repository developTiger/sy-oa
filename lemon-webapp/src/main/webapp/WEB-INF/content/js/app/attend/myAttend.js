            ...
            var calendar = $('#calendar').fullCalendar({
                ...
                events: //页面数据加载
                    function (start, end, timezone, callback) {
                        var sTime = start._d;
                        var startTime = dateFormat(sTime, "yyyy-MM-dd");
                        var eTime = end._d;
                        var endTime = dateFormat(eTime, "yyyy-MM-dd");
                        $.ajax({
                            url: "ajax_get_myAttend?t=" + new Date().getMilliseconds(),
                            type: "post",
