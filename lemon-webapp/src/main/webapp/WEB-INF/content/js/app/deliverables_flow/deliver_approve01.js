...
define(function (require, exports, module) {
    ...
    //加载数据
    function loadData1() {
        var tpl = require("text!app/tpl/delivers/deliverApproveTpl01.html");
    ...
    function approveProjectOK(selectids,ideas1) {
        var options = {
            url: "ajax_approveDeliver01?t=" + new Date().getMilliseconds() + "&ids=" + selectids + "&ideas=" + ideas1,
            type: 'get',
    ...
    function approveProjectNO(selectids,ideas2) {
        var options = {
            url: "ajax_rejectDeliver01?t=" + new Date().getMilliseconds() + "&ids=" + selectids + "&ideas=" + ideas2,
            type: 'get',
            success: function (data) {
                if(data=="success"){
                    alert("签核成功");
