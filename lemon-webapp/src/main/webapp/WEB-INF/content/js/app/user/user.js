...
define(function (require, exports, module) {
    ...
    function loadData() {
        ...
        var showOperate = $("#showOperate").val();
        if (showOperate == 0) {
    ...
    function loadData1() {
        var tpl = require("text!app/tpl/uauth/userInfoDatabaseTpl.html");
        var url = $("#searchForm").attr("data-url");
        var data = $("#searchForm").serialize().toString();
    ...
    $(".downloadCanRestYearAndSpa").click(function(){
        var type=$(this).attr("data-id");
        location.href="download_restYear_span"+"?t="+new Date().getMilliseconds()+"&inputType="+type;
    });
