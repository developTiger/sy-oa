...
define(function (require, exports, module) {
    ...
    //
    //function loadData() {
    //    var tpl = require("text!app/tpl/uauth/userBusinessTpl.html");
    ...
    $("body").delegate(".js_business_download","click",function(){
        var fromDate=$("input[name=strfromTime]").val();
        var endDate=$("input[name=strtoTime]").val();
        var target=$("input[name=target]").val();
        var targetName=$("input[name=applyerName]").val();
        $("input[name=sFromTime]").val(fromDate);
        $("input[name=sToTime]").val(endDate);
        $("input[name=targets]").val(target);
        $("input[name=aName]").val(targetName);
