...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "syy_kg06_plTpl8_kgk";
        var tpl = require("text!app/tpl/delivers/syy_kg_lc06_lotTpl8_kgk.html");
...
//群审批否决
    ...
    function ajax_lotProjectNO(prono,allContent) {
        var options = {
            url: "syy_kg_lc06_approve8_kgk?t=" + new Date().getMilliseconds() + "&ids=" + prono +"&allContent=" +encodeURI(encodeURI(allContent))+"&no=no",
            type: 'get',
...
//群审批同意
    ...
    function ajax_lotProjectYES(prono,allContent) {
        var options = {
            url: "syy_kg_lc06_approve8_kgk?t=" + new Date().getMilliseconds() + "&ids=" + prono +"&allContent=" +encodeURI(encodeURI(allContent)),
            type: 'get',
            success: function (data) {
                if(data=="success"){
                    alert("签核成功");
