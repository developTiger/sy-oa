...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "syy_kg06_plTpl6";
        var tpl = require("text!app/tpl/delivers/syy_kg_lc06_lotTpl6.html");
...
//群审批否决
    $("body").delegate("#lotReject", "click", function () {
        ...
        var zgld = $(".leaders").val();
        //if(zgld==null || zgld==""){
        //    alert("请选择主管领导");
        //    return false;
        //}
        ajax_lotProjectNO(chk_value.toString(),allContent,zgld);
    });
    function ajax_lotProjectNO(prono,allContent,sid) {
        var options = {
            url: "syy_kg_lc06_approve6?t=" + new Date().getMilliseconds() + "&prono=" + prono + "&empids=" +sid+"&allContent=" +encodeURI(encodeURI(allContent))+"&no=no",
            type: 'get',
