...
define(function (require, exports, module) {
    ...
    function loadData() {
        var url = "syy_kg06_plTpl04";
        var tpl = require("text!app/tpl/delivers/syy_kg_lc06_lotTpl04.html");
...
//群审批否决
    ...
    function ajax_lotProjectNO(prono,sid,allContent) {
        var options = {
            url: "syy_kg_lc06_approve4?t=" + new Date().getMilliseconds() + "&prono=" + prono + "&empids=" +sid+"&allContent=" +encodeURI(encodeURI(allContent))+"&no=no",
            type: 'get',
...
//群审批同意
    $("body").delegate("#lotApprove", "click", function () {
        ...
        var allContent=$("#allContent").val();
        ajax_lotProjectYES(chk_value.toString(),sid.toString(),allContent);
    });
