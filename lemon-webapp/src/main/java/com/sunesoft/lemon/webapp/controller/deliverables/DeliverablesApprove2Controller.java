 ...
 */
@Controller
public class DeliverablesApprove2Controller extends Layout{
    ...
    @RequestMapping("deliver_app2")
    public ModelAndView syy_kg_lc04(Model model,HttpServletRequest request){

        return view(layout,"deliverables_flow/deliver02",model);
    }

    @RequestMapping(value = "deliver_query02", method = RequestMethod.GET)
    public void deliver_query02(DeliverResearchCriteria criteria,HttpServletRequest request,HttpServletResponse response) throws UnsupportedEncodingException {
        PagedResult<FormDeliverApplyDto> deliverDtoPagedResult = formDeliverApplyService.getDeliverApproves2(criteria);
    ...
    //意见及审批同意
    @RequestMapping(value = "ajax_approveDeliver02")
    ...
    //意见及审批拒绝
    @RequestMapping(value = "ajax_rejectDeliver02")
