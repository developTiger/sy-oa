 ...
 */
@Controller
public class DeliverablesApprove1Controller extends Layout{
    ...
    @RequestMapping("deliver_app1")
    public ModelAndView syy_kg_lc04(Model model,HttpServletRequest request){

        return view(layout,"deliverables_flow/deliver01",model);
    }
    @RequestMapping(value = "deliver_query01", method = RequestMethod.GET)
    public void deliver_query01(DeliverResearchCriteria criteria,HttpServletRequest request,HttpServletResponse response) throws UnsupportedEncodingException {
        PagedResult<FormDeliverApplyDto> deliverDtoPagedResult = formDeliverApplyService.getDeliverApproves1(criteria);
    ...
    //意见及审批同意
    @RequestMapping(value = "ajax_approveDeliver01")
    ...
    //意见及审批拒绝
    @RequestMapping(value = "ajax_rejectDeliver01")
