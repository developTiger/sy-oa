...
import com.sunesoft.lemon.syms.uAuth.application.SysPermissionGroupService;
...
//        return view("uAuth/_deleteRoleForm", model);
    ...
    public ModelAndView addMenuForm(Model model, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!StringUtils.isNullOrWhiteSpace(id)) {
            ...
            List<PermissionGroupDto> list1 = roleDto.getPrivilegeGroupList();
...
//        List<RoleTypeDto> roleTypeDtos=roleTypeService.getCanUse();
//        model.addAttribute("roleTypes",roleTypeDtos);
    ...
    public void addOrUpdateUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        roleDto.setPrivilegeGroupList(list);
        if (!StringUtils.isNullOrWhiteSpace(id)) {
